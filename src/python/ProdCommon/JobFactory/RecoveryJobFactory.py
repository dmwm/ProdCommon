...
"""
_RecoveryJobFactory_

Given a processing workflow, generate a complete set of
job specs for it.

This is a improved clone of the ReRecoJobFactory. It also processes OnlyList
restriction.
...
class RecoveryJobFactory:
    """
    _RecoveryJobFactory_

    Working from a processing Workflow template, generate
    a complete set of job spec files from it. This processes OnlyFiles
    restriction
